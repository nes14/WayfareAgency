...
This project used the Agency Theme as a starting point and built off that.

Took advantage of all the built-in functionality. 

Live Demo can be found at : http://217.199.187.198/nestormanuel.com/Agency/ 
